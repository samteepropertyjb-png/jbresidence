...
const ALL_ARTICLES = [
  ...
  { title: 'Why Are There So Many Empty and Unfinished Buildings in Medini?', title_zh: '为什么Medini有这么多空置和未完工的建筑？', summary: 'Why some Medini buildings remain quiet or delayed, what government initiatives can realistically change, and how buyers should assess the area in 2026.', summary_zh: '分析Medini部分建筑为何长期空置或延迟、政府措施实际能改变什么，以及2026年买家应如何判断这个地区。', body: 'exists', image_url: 'photos/bodaiju/Aerial view 2.jpeg', link: '/articles/why-medini-empty-unfinished-buildings', area: 'Iskandar Puteri', topics: 'iskandar-puteri,buying-guide,js-sez' },
  ...
  { title: 'Forest City Tax Incentives: What They Actually Mean', title_zh: '森林城市税务优惠：实际意味着什么？', summary: 'Which companies and knowledge workers may qualify, what property buyers should not assume, and the checks to make before relying on any SFZ incentive.', summary_zh: '哪些企业与知识型人才可能符合资格、房产买家不应作出的假设，以及采用任何SFZ优惠前需要确认的事项。', body: 'exists', image_url: 'photos/forest-city/sfz-mm2h-night-skyline.jpg', link: 'articles/forest-city-tax-incentives-explained.html', area: 'Forest City', topics: 'forest-city,js-sez,buying-guide' },
