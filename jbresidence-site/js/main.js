...
const ALL_ARTICLES = [
  ...
  { title: 'Is Sunway City Iskandar Puteri Worth Buying in 2026?', summary: 'An honest buyer\'s guide to Sunway City — 2,000 acres, RM30B GDV, Build-Own-Operate model, Second Link access, and who this township genuinely suits.', body: 'exists', image_url: 'photos/sunway-iskandar/sunway-iskandar-drone.jpg', link: 'articles/is-sunway-city-iskandar-puteri-worth-buying-2026.html', area: 'Iskandar Puteri', topics: 'iskandar-puteri,buying-guide' },
  { title: 'Sunway City vs Horizon Hills vs Eco Botanic: Which Should You Buy?', summary: 'Direct comparison of three major Iskandar Puteri townships — tenure, schools, developer model, maturity, and which buyer profile fits each.', body: 'exists', image_url: 'photos/sunway-iskandar/sunway-town.jpg', link: 'articles/sunway-city-vs-horizon-hills-vs-eco-botanic.html', area: 'Iskandar Puteri', topics: 'iskandar-puteri,buying-guide' },
  { title: 'Schools in Sunway City Iskandar Puteri: Full Guide for Families 2026', summary: 'Every school inside Sunway City — Sunway International School, SJK(C) Cheah Fah, Treehouse Playschool, 42 coding school, swim school, equestrian and more.', body: 'exists', image_url: 'photos/eco-botanic/educity.jpg', link: 'articles/schools-sunway-city-iskandar-puteri-families.html', area: 'Iskandar Puteri', topics: 'iskandar-puteri,buying-guide' },
  { title: 'Sunway City Iskandar Puteri: The 2,000-Acre Township Explained', summary: 'The factual overview of Sunway City — size, GDV, five pillars, BOO model, security setup, and what it means to buy within an integrated township.', body: 'exists', image_url: 'photos/sunway-iskandar/sunway-iskandar-aerial.jpg', link: 'articles/sunway-city-iskandar-puteri-township-explained.html', area: 'Iskandar Puteri', topics: 'iskandar-puteri' },
  { title: 'Why Sunway City Iskandar Puteri Is One of Malaysia\'s Greenest Townships', summary: 'Net zero by 2050, 4,998 MWh solar, 534,000 trees, 104,000 mangroves, GreenRE Platinum school — the real sustainability data behind Sunway City.', body: 'exists', image_url: 'photos/sunway-iskandar/sunway-iskandar-waterfront.jpg', link: 'articles/sunway-city-iskandar-puteri-greenest-township.html', area: 'Iskandar Puteri', topics: 'iskandar-puteri' },
  { title: 'Sunway City Iskandar Puteri for Retirees: Lifestyle, Wellness and MM2H', summary: 'Security, walkability, wellness, natural environment, and healthcare access honestly assessed for retirees evaluating Sunway City as a retirement destination.', body: 'exists', image_url: 'photos/sunway-iskandar/sunway-iskandar-waterfront.jpg', link: 'articles/sunway-city-iskandar-puteri-retirees-guide.html', area: 'Iskandar Puteri', topics: 'iskandar-puteri,retirement,mm2h' },
  { title: 'Signature Home at Sunway City Iskandar Puteri: What Buyers Need to Know', summary: 'What Signature Home is, what the Signature Home Rewards promotion means, and the key questions to ask before committing to a purchase.', body: 'exists', image_url: 'photos/sunway-iskandar/sunway-big-box-office.jpg', link: 'articles/signature-home-sunway-city-iskandar-puteri.html', area: 'Iskandar Puteri', topics: 'iskandar-puteri,buying-guide' },
  { title: 'Sunway City Iskandar Puteri and the JS-SEZ: What Investors Need to Know', summary: 'How the Johor-Singapore Special Economic Zone affects Sunway City — commercial demand, residential spillover, and the honest long-term investment case.', body: 'exists', image_url: 'photos/sunway-iskandar/sunway-iskandar-aerial.jpg', link: 'articles/sunway-city-iskandar-puteri-js-sez-investors.html', area: 'Iskandar Puteri', topics: 'iskandar-puteri,js-sez' },
  { title: 'Buying Near the Second Link: Sunway City vs Forest City', summary: 'Two major developments near Tuas compared directly — lifestyle, tenure, schools, SFZ designation, community maturity and which buyer profile fits each.', body: 'exists', image_url: 'photos/sunway-iskandar/sunway-second-link.jpg', link: 'articles/second-link-sunway-city-vs-forest-city.html', area: 'Iskandar Puteri', topics: 'iskandar-puteri,forest-city,buying-guide' },
  { title: 'Sunway International School Iskandar Puteri: Is It Worth Living Nearby?', summary: 'Canadian/IB curriculum from K–Grade 12 — a property buyer\'s guide to living near or within Sunway City for school access, who it suits, and what to consider.', body: 'exists', image_url: 'photos/eco-botanic/educity.jpg', link: 'articles/sunway-international-school-iskandar-puteri.html', area: 'Iskandar Puteri', topics: 'iskandar-puteri,buying-guide' },
  // Forest City
